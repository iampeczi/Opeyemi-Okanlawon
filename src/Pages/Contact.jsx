...
Got a project in mind or interested in collaborating? Don’t hesitate to reach out. I'm always excited to explore new ideas and
          opportunities.
        </p>
        <div className=" min-w-full reveal-on-scroll ">
          <div className="space-y-8 item-start  flex flex-col ">
            ...
            <div className="flex flex-col pt-4 justify-center items-start ">
              <h4 className=" py-4 text-start width-full text-sm ">Connect with me</h4>
              <div className="flex space-x-4">
                <a target="_blank" href="https://www.linkedin.com" className="hover:text-secondary transition-colors duration-300">
                  <FaLinkedin />
                </a>
                <a target="_blank" href="https://www.x.com" className="hover:text-secondary transition-colors duration-300">
                  <BsTwitterX />
                </a>
                <a target="_blank" href="https://www.facebook.com" className="hover:text-secondary transition-colors duration-300">
                  <FaFacebook />
                </a>
                <a target="_blank" href="https://www.instagram.com" className="hover:text-secondary transition-colors duration-300">
                  <BsInstagram />
                </a>
              </div>
            </div>
