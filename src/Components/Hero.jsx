...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="container h-screen bg-background mt-8 overflow-hidden "
    >
      {/* desktop */}
      <div className="hidden lg:flex w-full h-[calc(100vh)] lg:bg-background">
        <div className="flex-1 w-full h-full">
          <div className=" flex-col flex justify-center items-center h-full">
            <p className="mb-1 font-semibold momo-signature-regular ">
              Welcome! My name is
            </p>
            <h1 className="text-4xl md:text-7xl momo-signature-regular">
              Opeyemi.<span className="text-secondary">O</span>.
            </h1>
            <h3 className="mt-6 font-semibold momo-signature-regular">
              I build things for the web.
            </h3>
            <button className="btn mt-6 animate-border border hover:border-0">
      ...
      >
        <div className="flex-col min-w-full flex justify-center items-start text-center px-8 py-2 gap-4 ">
          <h1 className="w-full overflow-hidden flex-col flex justify-center items-start space-y-1 md:space-y-3">
            ...
            <span className="text-4xl md:text-6xl momo-signature-regular ">
              Opeyemi.<span className="text-secondary">O</span>.
            </span>
          ...
          <button className="btn mt-4 border animate-border hover:border-0">
            <a href="#projects">View My Projects</a>
          </button>
        </div>
        {isScroll ? (
